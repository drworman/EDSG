...
"""PyInstaller spec for the participant binary.

Build with:
    pyinstaller packaging/participant.spec --noconfirm
...
APP_NAME = "EDSG-Participant"
ICON = ROOT / "packaging" / "icons" / "edsg.ico"
ICNS = ROOT / "packaging" / "icons" / "edsg.icns"

a = Analysis(**analysis_kwargs("participant_main.py", [] + ["edsg.gui.participant"]))
pyz = PYZ(a.pure)
...
if sys.platform == "darwin":
    app = BUNDLE(
        ...
        name=f"{APP_NAME}.app",
        icon=icon,
        bundle_identifier="com.edsg.participant",
        info_plist={
            "CFBundleName": APP_NAME,
            "CFBundleDisplayName": "ED: Squad Goals - Event Participant",
